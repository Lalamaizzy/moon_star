										...
										<div class="dashboard-comment-wrap has-row-actions">
											...
											<p class="row-actions">
												| <span class=""> <a data-comment-id="1268"
													href="/admin/comment/reply/${c.commentArticleId }"> 回复 </a>
												</span> <span class=""> | <a href="/admin/comment/edit/${c.commentArticleId }">编辑</a>
												</span> <span class=""> | <a href="javascript:void(0)"
													onclick="deleteComment(${c.commentArticleId })">删除</a>
												</span>
											</p>
										</div>
									</li>
